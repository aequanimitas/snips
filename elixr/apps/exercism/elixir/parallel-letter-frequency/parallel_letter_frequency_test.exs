...
ExUnit.start
ExUnit.configure exclude: :pending, trace: true, async: true
...
defmodule FrequencyTest do
  ...
  """
  setup do
    {_, dispatcher_pid} = Dispatcher.start
    on_exit fn -> GenServer.stop(dispatcher_pid) end
    {:ok, process: dispatcher_pid}
  end
